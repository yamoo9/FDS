...
| 3.[<s>13</s>,<s>14</s>,<s>15</s>]      | <s>Ajax</s> / jQuery Library / <s>Babel</s> / Webpack / <s>ECMAScript 2015(ES6)</s> |      |
| 3.[17,20,21,22,24]              | Vue JS Framework + SPA                   | ⏣ 수업 미진행 분량은 동영상 강의로 대체 예정(프로젝트에 필요한 부분) |
