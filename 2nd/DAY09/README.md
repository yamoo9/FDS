...
&#42; 이때 대입하는 함수는 이름이 없는 함수 (함수 리터럴, 무명, 익명 함수, 식) 등으로 불린다.
이제 이벤트가 연결되면
클릭한 후에 각각의 텍스트가 출력된다.  
...
###<push/pull 모듈>###
push, pull 모듈은 position: relative를 가져야 한다.  
...
1380/12 - (14*2) = 87 
&#42; 포토샵 > view > New guide layout 들어가서 값을 입력하면 표 그려짐
##### 위의 코드를 정리하면, #####
>
페이지 폭 : 1380px  
컬럼 개수 : 12  
...
```js
function clacWidth(x){ return 87&#42;x+((14&#42;2) &#42; (x-1)); }
```

  x 값에 2,3,4 대입하면 각각의 값을 구할 수 있음  
  clacWidth(2)=202  
  clacWidth(3)=317...
-----------
>
